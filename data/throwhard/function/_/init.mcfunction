...
data modify storage throwhard:config throw.item set value {enable:true, add:false, force:{transfer_player_motion:true, base:0.27d, fling:{multiplier:0.6d}, variation:{magnitude:{min:-0.03, max:0.04}, rotation:{radial:{min:0, max:5}}}}}
