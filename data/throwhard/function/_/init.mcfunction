...
data modify storage throwhard:config throw.splash_potion set value {enable:true, add:false, force:{transfer_player_motion:true, base:0.35d, fling:{multiplier:0.59d}, variation:{magnitude:{min:-0.03, max:0.07}, rotation:{radial:{min:0, max:4}}}}}
