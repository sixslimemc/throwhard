...
data modify storage throwhard:config throw.ender_pearl set value {enable:true, add:false, force:{transfer_player_motion:true, base:1d, fling:{multiplier:1.5d}, variation:{rotation:{radial:{min:0, max:1}}}}}
