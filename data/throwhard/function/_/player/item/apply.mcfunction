...
execute store result score *y _throwhard run data get storage six:out magnitude.result 14
scoreboard players operation *x _throwhard -= *y _throwhard
execute if score *x _throwhard matches ..4 run scoreboard players set *x _throwhard 5
